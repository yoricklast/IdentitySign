        ...
        <div id="attr-checks">
          ...
          {#if version == "0"}
            <div class="mb-3 form-check form-check-inline">
              ...
              />
              <label class="form-check-label" for="checkAddress">Address</label>
            </div>
          {/if}
          <div class="form-text">
      ...
      <div class="d-flex gap-4">
        ...
        {#if request != ""}
          <p class="btn-generate mb-0 align-self-center" in:fade>
            <span class="bi bi-arrow-down-circle-fill me-2"></span>See request
            below
          </p>
        {/if}
      </div>
  ...
  {#if request != ""}
    <div class="mb-3 request">
      <label for="request-textarea" class="form-label">
        Please note: this request does <b>not</b> include the document itself! Attach
        the file when sharing this request.
      </label>
      <textarea
        class="form-control"
        id="request-textarea"
      ...
      <h5 class="verify-warning text-primary">
        ...
        Verify the signature using IdentitySign before trusting a document you receive!
      </h5>
    </div>
  {/if}
</div>
